// ======= شريط الأخبار =======
const newsItems = [
  { text: "إعلان: استقبال ملفات برنامج التضامن ابتداءً من 01 سبتمبر.", url: "#news" },
  { text: "تكريم متطوعي الحملة الشتوية لدعم الأشخاص بدون مأوى.", url: "#news" },
  { text: "فتح باب التسجيلات للأشخاص ذوي الإعاقة للاستفادة من الأجهزة المساعدة.", url: "#services" },
  { text: "بلاغ: أوقات العمل في الصيف من الأحد إلى الخميس 8:00-15:00.", url: "#contact" }
];
